...
uint16_t LSM9DS1::begin(uint8_t agAddress, uint8_t mAddress, I2C_HandleTypeDef* i2c)
{
...
void LSM9DS1::initSPI() {
    #ifdef DEBUG
    printf("SPI mode not supported for LSM9DS1\n");
    #endif
...
void LSM9DS1::I2CwriteByte(uint8_t address, uint8_t subAddress, uint8_t data) {
    ...
    HAL_I2C_Mem_Write(settings.device.i2c, address, subAddress, 1, &data, 1, LSM9DS1_TIMEOUT);
}
...
uint8_t LSM9DS1::I2CreadByte(uint8_t address, uint8_t subAddress)
{
    ...
    HAL_I2C_Mem_Read(settings.device.i2c, address, subAddress, 1, &data, 1, LSM9DS1_TIMEOUT);
...
uint8_t LSM9DS1::I2CreadBytes(uint8_t address, uint8_t subAddress, uint8_t * dest, uint8_t count)
{
    ...
    retVal = HAL_I2C_Mem_Read(settings.device.i2c, address, subAddress | 0x80, 1, dest, count, LSM9DS1_TIMEOUT);
    if(HAL_OK != retVal) {
        return 0;
    }
